Run a full review of the montly codebase by launching all six specialist agents in parallel, then aggregate their findings into a single prioritised report.

Launch these six agents **simultaneously** (single message, multiple Agent tool calls):
